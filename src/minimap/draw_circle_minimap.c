...
/*   Updated: 2025/01/21 14:21:03 by fsalomon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d_bonus.h"

static void	draw_circle_map_border(t_parsing *info, int xc, int yc, int radius)
{
	int	x;
	int	y;
...
{
	draw_circle_map_border(info, MINI_MAP_CENTER, MINI_MAP_CENTER,
		MINI_MAP_RAY_BORDER);
